...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeIPLatencyEntry) DeepCopyInto(out *NodeIPLatencyEntry) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeIPLatencyEntry.
func (in *NodeIPLatencyEntry) DeepCopy() *NodeIPLatencyEntry {
	if in == nil {
		return nil
	}
	out := new(NodeIPLatencyEntry)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeIPLatencyStat) DeepCopyInto(out *NodeIPLatencyStat) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	if in.NodeIPLatencyList != nil {
		in, out := &in.NodeIPLatencyList, &out.NodeIPLatencyList
		*out = make([]NodeIPLatencyEntry, len(*in))
		copy(*out, *in)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeIPLatencyStat.
func (in *NodeIPLatencyStat) DeepCopy() *NodeIPLatencyStat {
	if in == nil {
		return nil
	}
	out := new(NodeIPLatencyStat)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NodeIPLatencyStat) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeIPLatencyStatList) DeepCopyInto(out *NodeIPLatencyStatList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]NodeIPLatencyStat, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeIPLatencyStatList.
func (in *NodeIPLatencyStatList) DeepCopy() *NodeIPLatencyStatList {
	if in == nil {
		return nil
	}
	out := new(NodeIPLatencyStatList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NodeIPLatencyStatList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
